...
const styles = {
  ...
  card: { background: 'rgba(28, 28, 30, 0.95)', padding: '44px 40px', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.08)', boxShadow: '0 8px 40px rgba(0,0,0,.5)', width: '100%', maxWidth: '420px', backdropFilter: 'blur(20px)' },
